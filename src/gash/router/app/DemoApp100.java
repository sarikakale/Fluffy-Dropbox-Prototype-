...
public class DemoApp100 implements CommListener {
	...
	public DemoApp100(MessageClient mc) {
		init(mc);
	}
			...
			try {
				...
				MessageClient mc;
					...
					if(MessageClient.leaderIp!=null){
					    ...
					    mc = new MessageClient("192.168.1.32", 3000);
					}

				DemoApp100 da = new DemoApp100(mc);
				...
				System.out.println("Before and After"+(after-before));
