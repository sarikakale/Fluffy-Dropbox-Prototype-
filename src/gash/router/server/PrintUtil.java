...
public class PrintUtil {
	...
	public static void printCommand(CommandMessage msg) {
		...
		else if (msg.hasUploadData()) {
			System.out.println("Uploaded Message");
			System.out.println(PrintUtil.gap + "Msg:  " + msg.getUploadData().size());
		} else if(msg.getAction().equals(Pipe.Action.READ)){
			System.out.println("Read File");
			System.out.println(PrintUtil.gap + "Msg:  " );
		}else
	...
	//	System.out.println(msg.getBeat().getQueue());
		System.out.println("#######"+msg.getBeat().getTotalNodes());
		...
		if (msg.hasErr())
			...
			System.out.println("Heartbeat "+msg.getBeat());
		else
			System.out.println("Unknown");
