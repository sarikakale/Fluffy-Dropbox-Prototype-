...
public class ServerState {
	...
	private static ConcurrentMap<Integer, Channel> channelMap=new ConcurrentHashMap<Integer, Channel>();
	...
	public static ConcurrentMap<Integer, Channel> getChannelMap() {
		return channelMap;
	}

	public static void setChannelMap(ConcurrentMap<Integer, Channel> channelMap) {
