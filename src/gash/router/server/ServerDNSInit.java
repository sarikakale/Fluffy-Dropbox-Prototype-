...
import gash.router.dns.server.DNSServerHandler;
...
public class ServerDNSInit  extends ChannelInitializer<SocketChannel> {
	boolean compress = false;
	ServerState state;

	public ServerDNSInit( boolean enableCompression) {
		super();
